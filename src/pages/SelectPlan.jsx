...
{/*
      ...
      <span className="info">After Payment Please Fill Out Below Form to Confirm the Transaction </span>
      </div>
...
*/}
      ...
      <div className="user-form">
        <TransactionForm setAmount={setAmount} amount= {amount} handleUpiAppPayment={handleUpiAppPayment} copyToClipboard={copyToClipboard} />
      </div>
    </div>
  );
};
